	...
	<table width='99%' height="100%" border='0' cellspacing='0' cellpadding='0'>
	  <tr>
	    <td style='padding-left:3px;padding-top:8px' valign="top">
	      ...
	      <dl class='bitem'>
	        <dt onClick='showHide("items2_1")'><b>客房信息管理</b></dt>
	        <dd style='display:block' class='sitem' id='items2_1'>
	          <ul class='sitemu'>
	            <li><a href='<%=path %>/catelogMana.action' target='main'>客房信息类型</a> </li>
	            <li><a href='<%=path %>/kefangMana.action' target='main'>客房信息管理</a> </li>
	            <li><a href='<%=path %>/admin/kefang/kefangAdd.jsp' target='main'>客房信息添加</a> </li>
	          </ul>
	        </dd>
	      </dl>
	      <dl class='bitem'>
	      ...
	      <dl class='bitem'>
	        <dt onClick='showHide("items2_1")'><b>入住信息管理</b></dt>
	        <dd style='display:block' class='sitem' id='items2_1'>
	          <ul class='sitemu'>
	            <li><a href='<%=path %>/ruzhuMana.action' target='main'>入住信息管理</a> </li>
	            <li><a href='<%=path %>/admin/ruzhu/ruzhuAdd.jsp' target='main'>入住信息添加</a> </li>
	          </ul>
	        </dd>
	      </dl>
	      <dl class='bitem'>
	        ...
	        <dd style='display:block' class='sitem' id='items3_1'>
	          <ul class='sitemu'>
	            <li><a href='<%=path %>/admin/gonggao/gonggaoAdd.jsp' target='main'>公告信息添加</a> </li>
	            <li><a href='<%=path %>/gonggaoMana.action' target='main'>公告信息管理</a> </li>
	          </ul>
	        </dd>
	      </dl>
	      <dl class='bitem'>
	        <dt onClick='showHide("items4_1")'><b>留言板---管理</b></dt>
	        <dd style='display:block' class='sitem' id='items3_1'>
	          <ul class='sitemu'>
